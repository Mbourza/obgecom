                    ...
                    <form id="signupStep2Form">
                        ...
                        <div class="verification-step active" id="personalInfoStep">
                            ...
                            <div class="form-buttons">
                                ...
                                <button type="button" class="form-button" onclick="verifyPhoneNumber()" id="verifyPhoneButton">
                                    <span class="spinner"></span>
                        ...
                        <div class="verification-step" id="phoneVerificationStep">
                            <div class="verification-header">
                                <h3 style="text-align: center; color: #333; margin-bottom: 10px;">Verify Your Phone Number</h3>
                                <p style="text-align: center; color: #666; margin-bottom: 20px;">
                                    We sent a verification code to <strong id="verificationPhoneNumber">+212 XXXXXXXX</strong>
                                </p>
                            </div>
                            ...
                            <div class="resend-code">
                                <button type="button" class="resend-button" onclick="resendVerificationCode()" id="resendButton">
                                    Resend Code
                                </button>
                        ...
                        <!-- Terms and Conditions (will be shown after phone verification) -->
    ...
    <script>
        ...
        async function verifyPhoneNumber() {
            ...
            try {
                ...
                // Call your backend to send verification
                const response = await fetch('./dashboard/controllers/send_verification_sms.php', {
                    method: 'POST',
                    headers: {
                ...
                if (data.success) {
                    ...
                    if (data.verification_code) {
                        ...
                        // Show method-specific notification
                        if (data.method === 'whatsapp') {
                            showNotification(
                                `📱 Verification code sent via WhatsApp! ${data.test_mode ? 'Code: ' + verificationCode : ''}`, 
                                'success', 
                                8000
                            );
                        } else {
                            showNotification(
                                `📲 Verification code sent via SMS! ${data.test_mode ? 'Code: ' + verificationCode : ''}`, 
                                'success', 
                                8000
                            );
                        }
        ...
        async function verifyCode() {
            ...
            try {
                ...
                const response = await fetch('./dashboard/controllers/verify_phone_code.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        */
        ...
        function redirectToPayment(formHtml, transactionId) {
            console.log('Redirecting to payment gateway with transaction ID:', transactionId);
